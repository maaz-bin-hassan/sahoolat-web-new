        ...
        >
          ...
          <div className="bg-white rounded-2xl p-8 shadow-card border-2 border-secondary mb-8">
            ...
            <nav className="space-y-2 text-primary">
              ...
              <p><a href="#information-collect" className="hover:underline">1. Information We Collect</a></p>
              <p><a href="#how-we-use" className="hover:underline">2. How We Use Your Information</a></p>
              <p><a href="#how-we-share" className="hover:underline">3. How We Share Your Information</a></p>
              ...
              <p><a href="#international-transfers" className="hover:underline">8. International Data Transfers</a></p>
              ...
              <p><a href="#regional-rights" className="hover:underline">14. Regional Privacy Rights</a></p>
