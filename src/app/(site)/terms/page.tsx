            ...
            <div className="flex-1 bg-white rounded-2xl p-8 shadow-card border-2 border-secondary space-y-8">
              ...
              <section id="payments">
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-secondary/30 rounded-lg p-4 mb-4">
                    <p className="text-midnight_text text-18 font-semibold mb-2">For Service Providers:</p>
                    <ul className="list-disc ml-6 text-dark_grey text-18 leading-relaxed space-y-1">
                      <li><span className="font-semibold">Expert Services:</span> 10% commission on completed transactions</li>
                      <li><span className="font-semibold">Shopping/E-commerce:</span> 2% commission on completed shopping-related transactions</li>
                      <li>Commission is calculated on the total transaction amount or bid amount</li>
                      <li>Payment processing fees (typically 2-3%) may apply</li>
                    </ul>
                  </div>
                </div>
              ...
              <section id="ip">
                ...
                <div>
                  ...
                  <p className="text-dark_grey text-18 leading-relaxed">
                    You retain ownership of content you submit but grant us a license to use, display, and process it as necessary to operate the Platform.
                  </p>
                </div>
              </section>
              ...
              <section id="disclaimers">
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-secondary/30 rounded-lg p-4">
                    <p className="text-midnight_text text-16 uppercase">
                ...
                <div className="mb-6">
                  ...
                  <ul className="list-disc ml-6 text-dark_grey text-18 leading-relaxed space-y-1">
                    ...
                    <li>Quality, safety, or legality of Services or products</li>
                    <li>Successful transactions or satisfactory outcomes</li>
                  </ul>
                </div>

                <div>
                  <h3 className="text-primary text-21 font-semibold mb-3">14.3 Limitation of Liability</h3>
              ...
              <section id="indemnification">
                ...
                <p className="text-dark_grey text-18 leading-relaxed mb-4">
                  You agree to indemnify, defend, and hold harmless Sahoolat AI from any claims, liabilities, damages, losses, costs, or expenses arising from:
                </p>
                <ul className="list-disc ml-6 text-dark_grey text-18 leading-relaxed space-y-1">
              ...
              <section id="disputes">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-dark_grey text-18 leading-relaxed">
                    Before initiating formal proceedings, contact us at <a href="mailto:support@sahoolatai.com" className="text-primary hover:underline">support@sahoolatai.com</a> to resolve disputes informally.
                  </p>
                </div>
              ...
              <section id="termination">
                ...
                <div>
                  <h3 className="text-primary text-21 font-semibold mb-3">18.2 Effect of Termination</h3>
              ...
              <section id="general">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-primary text-18 font-semibold mb-2">19.1 Entire Agreement</h3>
                    <p className="text-dark_grey text-18 leading-relaxed">
                      These Terms, along with our Privacy Policy, constitute the entire agreement between you and Sahoolat AI.
                    </p>
                  </div>

                  <div>
                    <h3 className="text-primary text-18 font-semibold mb-2">19.2 Severability</h3>
                    <p className="text-dark_grey text-18 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-primary text-18 font-semibold mb-2">19.3 Force Majeure</h3>
                    <p className="text-dark_grey text-18 leading-relaxed">
