...
// Buyer Features
const buyerFeatures = [
    { title: "AI-Powered Voice Search", icon: "/assets/ai-mic.png", description: "Simply speak, and AI understands your service needs instantly.", tag: "AI-Powered" },
    { title: "Instant Matchmaking", icon: "/assets/verified.png", description: "Get connected to the best-skilled workers in real time.", tag: "Smart Matching" },
    { title: "Real-time Audio Chat", icon: "/assets/audio.png", description: "Talk to service providers directly via voice chat.", tag: "Live Chat" },
    { title: "Offline Support (Premium)", icon: "/assets/offline.png", description: "Access expert services even without the internet.", tag: "Premium Feature" },
    { title: "End-to-End Encryption", icon: "/assets/secure.png", description: "Your conversations and data are 100% secure and private.", tag: "Secure" }
];
...
const expertFeatures = [
    { title: "AI-Powered Voice", icon: "/assets/speak.png", description: "Talk to AI to get matched with jobs effortlessly.", tag: "AI Assistant" },
    { title: "Instant Matchmaking", icon: "/assets/matchmaking.png", description: "Get job offers instantly based on your skills.", tag: "Smart Matching" },
    { title: "Showcase Skills with Videos", icon: "/assets/profile.png", description: "Upload short videos to demonstrate your skills.", tag: "Boost Visibility" },
    { title: "Offline Support (Premium)", icon: "/assets/offline.png", description: "Even without internet, clients can still find you.", tag: "Premium Feature" },
    { title: "Safe & Secure", icon: "/assets/secure.png", description: "We ensure a safe and fraud-free platform for professionals.", tag: "Trust & Safety" }
];
