...
export default function GetApp() {
    return (
        <section className="relative overflow-hidden text-center py-16 md:py-24 bg-gradient-to-r from-teal-500 via-teal-400 to-orange-400">
            ...
            <div className="relative z-10 flex flex-col items-center max-w-5xl mx-auto px-4">
                ...
                {/* Brand Tagline */}
                <div className="flex flex-wrap justify-center items-center text-white text-xl md:text-3xl font-bold space-x-2 mb-12">
