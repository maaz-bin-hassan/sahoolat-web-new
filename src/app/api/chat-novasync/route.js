...
import { SYSTEM_PROMPT_NOVASYNC_DYNAMICS } from "@/utils/SystemPrompts";
...
function setCorsHeaders(response) {
  response.headers.set("Access-Control-Allow-Origin", ["*", "https://www.novasyncdynamics.com", "https://sahoolat-chatbot.vercel.app"]);
...
export async function POST(request) {
  try {
    ...
    const htmlSystemPrompt = SYSTEM_PROMPT_NOVASYNC_DYNAMICS + `
