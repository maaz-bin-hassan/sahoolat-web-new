      ...
      <div className="lg:py-0 py-1 md:py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-3 md:px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="#early-access"
              className="hidden lg:flex items-center gap-2 bg-primary text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-primary/90 transition-all duration-300 shadow-button hover:shadow-card-hover"
            >
            ...
            <Link
              href="#early-access"
              className="hidden lg:flex items-center gap-2 bg-orange text-white font-semibold px-5 py-2.5 rounded-xl hover:bg-orange/90 transition-all duration-300 shadow-button hover:shadow-card-hover"
            >
        ...
        >
          ...
          <nav className="flex flex-col items-start p-4">
            ...
            <div className="mt-4 flex flex-col space-y-4 w-full">
              <Link
                href="#early-access"
                className="flex items-center justify-center gap-2 bg-primary text-white font-semibold px-5 py-3 rounded-xl hover:bg-primary/90 transition-all duration-300 shadow-button"
                onClick={() => {
                  setNavbarOpen(false);
                }}
              >
              ...
              <Link
                href="#early-access"
                className="flex items-center justify-center gap-2 bg-orange text-white font-semibold px-5 py-3 rounded-xl hover:bg-orange/90 transition-all duration-300 shadow-button"
                onClick={() => {
                  setNavbarOpen(false);
                }}
              >
